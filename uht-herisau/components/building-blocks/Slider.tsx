...
export const Slider = ({ slides, twFit }: { slides: { data: any[] }; twFit?: ClassValue }) => {
  ...
  const PointerButtons = (
    <div className='touch:hidden absolute bottom-0 right-0 z-10 size-[calc(min(20%,96px))]  bg-primary/20 flex items-center text-white typo-headline-xs justify-center px-8 gap-12 min-w-min backdrop-blur-xs'>
